...
Feature: User Registration
    ...
    Scenario: Invalid name
        Given I am at homepage
        And I click in register
        When I fill the form with the following information, name "", password "TestPa$$w0rd123" and email "test_email@email.com"
    ...
    Scenario: Invalid email
        Given I am at homepage
        And I click in register
        When I fill the form with the following information, name "Test Name", password "TestPa$$w0rd123" and email "test_email"
